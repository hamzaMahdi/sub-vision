...
class ProcessGate:
    ...
    def __init__(self):
        ...
        self.__filter_lines_min_length = 40.0
        self.__filter_lines_angle = [0.0, 360.0]

        self.filter_lines_output = None


    def process(self, source0,theta):
        """
        Runs the pipeline and sets all outputs to new values.
        """
        # Step Find_Lines0:
        self.__filter_lines_angle = [theta-20, theta+20]

        self.__find_lines_input = source0
    ...
    def __find_lines(input):
        ...
        if len(lines) != 0:
            for i in range(1, len(lines[0])):
                tmp = ProcessGate.Line(lines[0][i, 0][0], lines[0][i, 0][1],
